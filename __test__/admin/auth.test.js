...
describe('POST /register -> if email and username is given', () => {
  test('should register a USERS', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Wendell.Muller95',
        'password':'6FPvjjrfGBew7l4',
        'email':'Stefan.Kuvalis@hotmail.com',
        'contact_info':'CSS',
        'type':'PNG',
        'verifed':true,
        ...
        'CommissionRate':607,
        'DiscountRate':523,
        'DiscountUntil':'2024-05-17T01:49:16.706Z',
        'mobileNo':'(429) 520-7898',
        'ssoAuth':{
          'googleId':'Analyst',
          'facebookId':'deposit'
        }
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let USERS = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Stefan.Kuvalis@hotmail.com', });
